                ...
                <div class="mt-4">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                            ...
                            <!-- Delivery -->
                            <?php if(config('app.isft')  || (config('app.iswp')&&$order->delivery_method==1) ): ?>
                                <div class="row my-2">
                                    <div class="col-7 text-right">
...
<?php echo $__env->make('pdf-invoice::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/repairsp/whatsapp.tifinbox.pk/modules/PdfInvoice/Providers/../Resources/views/index.blade.php ENDPATH**/ ?>