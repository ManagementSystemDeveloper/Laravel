    ...
    <div class="section features-1">
      <div class="container">
        <div class="row">
          <div class="col-12 no-padding">
            <div class="nearby-header-container">
              <img class="bg-image" src="/images/default/nearby-top-banner-1.png" style="width: 100%; border-radius: 1rem;">
            </div>
          </div>
        </div>
        <div class="row mt-4">
        ...
        <div class="section-restaurant-block">
          <h2 class="nearby-restaurant-title">restaurants near me&nbsp;<small>(&nbsp;<?php $radius = intval(config('settings.nearby_radius')); echo $radius; ?>km )</small></h2>
...
<?php echo $__env->make('layouts.nearby', ['title' => __('Restaurants')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Freelancer\Restaurant mobile ui UK\eatin.pk\resources\views/restorants/nearby.blade.php ENDPATH**/ ?>