    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                <div class="input-group mb-4">
                    <input class="form-control" name="location" id="txtlocation" value="<?php echo e(request()->post('location')); ?>" placeholder="<?php echo e(__('Enter your street or address')); ?>" type="text" required>
...
<?php /**PATH E:\Freelancer\Restaurant mobile ui UK\eatin.pk\resources\views/layouts/headers/modallocation.blade.php ENDPATH**/ ?>