                        ...
                        <div class="text-center text-muted mb-4">
                           <h3><?php echo e(__('DEMO credentials:')); ?></h3>
                            ...
                            <?php if(config('settings.is_pos_cloud_mode')): ?>
                                <small>
                                    <br /><br /><b><?php echo e(__('STAFF')); ?></b><br/>
                                    <?php echo e(__('Username')); ?> <strong>staff@example.com</strong><br />
                                    <?php echo e(__('Password')); ?> <strong>secret</strong>
                                </small>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', ['class' => 'bg'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Freelancer\Restaurant mobile ui UK\eatin.pk\resources\views/auth/login.blade.php ENDPATH**/ ?>