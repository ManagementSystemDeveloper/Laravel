                        ...
                        <form method="post" action="{{ route('profile.update') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <!-- <div class="form-group{{ $errors->has('lat') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="lat" id="input-latitude" class="form-control form-control-alternative{{ $errors->has('lat') ? ' is-invalid' : '' }}" placeholder="{{ __('Latitude') }}" value="{{ old('lat', auth()->user()->lat) }}" required>
                                ...
                                <div class="form-group{{ $errors->has('lng') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="lng" id="input-longitude" class="form-control form-control-alternative{{ $errors->has('lng') ? ' is-invalid' : '' }}" placeholder="{{ __('Longitude') }}" value="{{ old('lng', auth()->user()->lng) }}" required>
