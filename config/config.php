    ...
    'env'=>[
        [
            ...
            'fields'=>[
                ...
                ['title'=>'Time for order to be prepared', 'help'=>'Average time order is prepared, so users can not order before restaurant or shop is closing', 'key'=>'TIME_TO_PREPARE_ORDER_IN_MINUTES', 'value'=>0, 'type'=>'hidden', 'onlyin'=>'ft'],
